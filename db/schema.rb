...
ActiveRecord::Schema[7.0].define(version: 20_231_129_002_618) do # rubocop:disable Metrics/BlockLength
  ...
  create_table 'repetions', force: :cascade do |t|
    t.integer 'reps'
    t.integer 'weight'
    t.integer 'workout_id', null: false
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index ['workout_id'], name: 'index_repetions_on_workout_id'
  end
  ...
  add_foreign_key 'repetions', 'workouts'
